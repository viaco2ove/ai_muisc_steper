...
with open(r'D:\Users\viaco\PycharmProjects\ai_muice_steper\backend\tmp1mipvl7d.json', encoding='utf-8') as f:
    kw = json.load(f)
...
# 加载脚本模块
script = r'D:/Users/viaco/PycharmProjects/ai_muice_steper/.workbuddy/skills/ai_adjust_vocal/scripts/main.py'
